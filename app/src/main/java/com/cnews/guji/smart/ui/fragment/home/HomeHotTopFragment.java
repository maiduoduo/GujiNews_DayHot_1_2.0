 ...
 * 头条推荐
 */
public class HomeHotTopFragment extends BaseMvpFragment<HomeHotTopPresenterimpl> implements HeaderView.RefreshDistanceListener,HomeHotTopContract.View, OnRefreshListener {
...
//        mSwipeToLoadLayout.setRefreshing(true);
    ...
    public void showError(Throwable throwable) {
        ILog.e(TAG, "头条推荐：------------------------> "+throwable.getMessage());
    }
