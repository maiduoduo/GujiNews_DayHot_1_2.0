 ...
 * des:图片首页
 */
public class HomeUserFragment4 extends BaseFragment {
    private static int SIZE = 20;
    private int mStartPage = 1;
    private static final String TAG = HomeUserFragment4.class.getSimpleName();
    ...
    public static HomeUserFragment4 getInstance(String title) {
        HomeUserFragment4 homeUserFragment4 = new HomeUserFragment4();
        return homeUserFragment4;
    }

    @Override
    protected int getLayoutResource() {
        return R.layout.frag_home_index2;
    }
