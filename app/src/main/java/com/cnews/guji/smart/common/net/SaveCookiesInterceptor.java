...
public class SaveCookiesInterceptor implements Interceptor {
    ...
    private Boolean isLoginAC;

    public SaveCookiesInterceptor(Context context) {
        mContext = context;
    }
    public SaveCookiesInterceptor(Context context, Boolean isLogin) {
        mContext = context;
        this.isLoginAC = isLogin;
    }
    ...
    private void saveCookie(String url, String domain, String cookies) {
        SharedPreferences sp = mContext.getSharedPreferences("tcxt_data", Context.MODE_PRIVATE);
