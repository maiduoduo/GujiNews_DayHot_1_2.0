 ...
 * 头条推荐
 */
public class HomeGXFragment extends BaseMvpFragment<HomeHotTopPresenterimpl> implements HeaderView.RefreshDistanceListener, HomeHotTopContract.View, OnRefreshListener {
